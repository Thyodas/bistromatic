...
{
    cr_assert_str_eq(eval_expr("0123456789", "()+-*/%",
    "6/(12+14%(30%5+(10*25)-46)+16)-20", 34),
    "-20");
    cr_assert_str_eq(eval_expr("0123456789", "()+-*/%",
    "-(12*(13+15/5*(6/(12+14%(30%5+(10*25)-46)+16)-20)/43)*20)*(-(12-98*42)*(16+63-50/3))", 84),
    "-744629760");
}
...
{
    cr_assert_str_eq(eval_expr("0123456789", "()+-*/%",
    "(6/(12+14%(30%5+(10*25)-46)+16)-20)/43", 39),
    "0");
    cr_assert_str_eq(eval_expr("0123456789", "()+-*/%",
    "((13+15/5*(6*(12+14*(30*5+(10*25)-46)+16)-20)*43))", 51),
    "3855049");
}